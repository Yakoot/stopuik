<template>
    <el-dialog
        ...
        <el-form :model="formData" :rules="rules" ref="reportForm" label-position="top" class="report-form">
            ...
            <el-row :gutter="20">
                ...
                <el-col :span="12">
                    <el-form-item label="Телефон" prop="phone">
                        <div class="el-input">
                            <input class="el-input__inner" @blur="phoneBlur" type="text" v-mask="'+7 (###) ###-##-##'"
                                   placeholder="+7 (999) 99-99-99" v-model="formData.phone">
                        </div>
                    </el-form-item>
                </el-col>
            </el-row>
            <el-row>
                <el-col :span="12">
                    <el-form-item label="Ваш статус на выборах" prop="status">
                        <el-select v-model="formData.status" :popper-append-to-body="false"
                                   no-data-text="Нет данных"
                                   label="Ваш статус на выборах" placeholder="Не определён">
                            <el-option
            ...
            <el-row :gutter="20">
                ...
                <el-col :span="8">
                    <el-form-item label="ИКМО">
                        <el-select v-model="formData.ikmo" filterable clearable no-data-text="Нет данных"
                                   :popper-append-to-body="false"
                                   label="ИКМО" placeholder="ИКМО">
                            <el-option
            ...
            <el-row :gutter="20">
                <el-col :span="8">
                    <el-form-item label="Выберите год" prop="year">
                        <el-select v-model="formData.year" no-data-text="Нет данных" :popper-append-to-body="false"
                                   label="Выберите год"
            ...
            <el-form-item label="Член избиркома, совершивший нарушение избирательного законодательства"
                          prop="uik_member">
        ...
        <div slot="footer" class="dialog-footer">
            <el-button :loading="buttonLoading" :disabled="!agreement" @click="submitForm('reportForm')">Отправить
            </el-button>
